...
public:
    ...
    {
        // set a total num, add 1 once rotten, add rotten into queue
        // bfs from the rotten cell, set step, until no orange is rotten
        // return steps if number matches, otherwise -1. 
